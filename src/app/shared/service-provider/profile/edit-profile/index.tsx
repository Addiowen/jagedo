...
const orgOtherDetails = Object.keys(organizationData).reduce((acc, key) => {
  if (
    !orgAccountDetailsKeys.includes(key) &&
    !orgUploadsKeys.includes(key)
  ) {
...
const professionalAccountDetailsKeys = ['Registered As', "Field",'Years of Experience', 'PIN Number' ];
const professionalUploadsKeys = ['Company Profile', 'Business Registration', 'Portfolio','NCA Licence'];



const professionalAccountDetails = splitData(professionalData, professionalAccountDetailsKeys);
const professionalUploads = splitData(professionalData, professionalUploadsKeys);

//CONTRACTOR DETAILS

// const contractorAccountDetailsKeys = ['First Name', 'Last Name', 'Phone Number', 'Email Address', 'Gender', 'Registered As'];
const contractorAccountDetailsKeys = ['Category 1', 'Level (Category 1)', 'Category 2', 'Level (Category 2)', 'Registered As'];
...
const professionalOtherDetails = Object.keys(professionalData).reduce((acc, key) => {
  if (
        ...
        <Tab.Panels>
          <Tab.Panel>
            <div className="items-start pt-5 @xl:grid-cols-3 @5xl:grid @5xl:grid-cols-3 @5xl:gap-7 @6xl:grid-cols-3 @7xl:gap-10">     
              <EditProfileCard user={professionalPath? 'Professional': 'Fundi'}editMode={editMode} setEditMode={setEditMode} setModalState={setModalState} />
              <div className='col-span-2'>
                ...
                <div className=' rounded-lg bg-gray-0 p-4 border border-gray-300 py-4'>
                  ...
                  <ProfileChunkedGrid data={contractor? contractorOtherDetails : professionalPath? professionalOtherDetails: orgPath? orgOtherDetails : otherDetails} dataChunkSize={16} editMode={editMode} />       
                </div>
              </div>
            </div>
          </Tab.Panel>
          ...
          <Tab.Panel>
            <div className="items-start pt-5 @xl:grid-cols-3 @5xl:grid @5xl:grid-cols-3 @5xl:gap-7 @6xl:grid-cols-3 @7xl:gap-10">     
                ...
                <div className='col-span-2'>
                  ...
                  <ProfileChunkedGrid data={contractor? contractorAccountDetails :  professionalPath ? professionalAccountDetails :
                     accountDetails} dataChunkSize={16} editMode={editMode} />       
                  </div>
                </div>
              </div>
          </Tab.Panel>
          ...
          <Tab.Panel>
            <div className="items-start pt-5 @xl:grid-cols-3 @5xl:grid @5xl:grid-cols-3 @5xl:gap-7 @6xl:grid-cols-3 @7xl:gap-10">     
              ...
              <div className='col-span-2'>
                ...
                <ProfileChunkedGrid data={contractor? contractorUploads :professionalPath ? professionalUploads: uploads} dataChunkSize={16} editMode={editMode} />       
                </div>
              </div>
            </div>
          </Tab.Panel>
