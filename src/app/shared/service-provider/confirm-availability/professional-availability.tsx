    ...
    <>
      ...
      <div className="my-4">
        <ChunkedGrid
          data={
            requestId === 'REQ0021'
              ? professionalRequestDetailsData[0]
              : professionalRequestDetailsData[1]
          }
          dataChunkSize={8}
        />
      </div>
      ...
      <div className="flex justify-center space-x-4 pt-5">
        {requestId === 'REQ0021' ? (
          <Link
            href={{
              pathname: routes.serviceProvider.professional.rfqStandardOne,
              query: { jobId },
            }}
          >
            <Button className="w-62">Create Quotation</Button>
          </Link>
        ) : (
          <Link
            href={{
              pathname: routes.serviceProvider.professional.rfqStandardTWo,
              query: { jobId },
            }}
          >
            <Button className="w-62">Create Quotation</Button>
