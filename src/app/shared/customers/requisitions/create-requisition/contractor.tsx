...
const GenerateInvoiceContractor: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const checkFormValidity = () => {
      if (description && date && county && subCounty && village && contractor) {
        setIsFormValid(true);
      } else {
    ...
    checkFormValidity();
  }, [description, date, county, subCounty, village, contractor, session]);
  ...
  return (
    <div className="relative">
      ...
      <div className="w-full rounded-lg bg-white p-4 shadow-md">
        <div>
          <PricingContractor onPlanSelect={handlePlanSelect} />
        </div>
