  ...
  return (
    <div className="@container">
      <div className="grid grid-cols-1 gap-6 @4xl:grid-cols-2 3xl:gap-8">
        ...
        <JobSlider className="h-[320px] @sm:h-[320px]  @7xl:col-span-4 @7xl:col-start-auto @7xl:row-start-auto" />
        {/* <TractionCard className="h-[300px] @sm:h-[320px] @4xl:col-start-2  @7xl:col-span-4 @7xl:col-start-auto @7xl:row-start-auto" /> */}
        <Notifications className="h-[320px] @sm:h-[320px] @7xl:col-span-4 @7xl:col-start-auto @7xl:row-start-auto" />
